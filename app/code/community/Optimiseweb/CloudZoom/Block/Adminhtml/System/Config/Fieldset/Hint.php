...
/**
 * Optimiseweb CloudZoom Block Adminhtml System Config Fieldset Hint
 *
 ...
 */
class Optimiseweb_CloudZoom_Block_Adminhtml_System_Config_Fieldset_Hint extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{

    protected $_template = 'optimiseweb/cloudzoom/system/config/fieldset/hint.phtml';
    ...
    {
        return (string) Mage::getConfig()->getNode('modules/Optimiseweb_CloudZoom/version');
    }

    public function getOptimisewebCloudZoomVersion()
    {
    ...
    public function getOptimiseWebUrl()
    {
        ...
        $url .= 'utm_source=Magento_Extension&utm_medium=Extension_Settings&utm_campaign=Optimiseweb_CloudZoom';
        return $url;
    }
